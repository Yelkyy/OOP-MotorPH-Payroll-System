...
public class LeaveRequestPanel extends javax.swing.JPanel {
        ...
        private void showLeaveRequests() {
                javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel) leaveListTable
                                .getModel();
                model.setRowCount(0);

                motorph.service.LeaveService service = new motorph.service.LeaveService();
                java.util.List<motorph.model.LeaveRequest> list = service
                                .findLeaveRequestsByEmployee(employee.getEmployeeNumber());

                for (motorph.model.LeaveRequest req : list) {
                        model.addRow(new Object[] {
                                        req.getRequestId(),
                                        req.getFormattedRequestDate(),
                                        req.getFormattedFromDate(),
                                        req.getFormattedToDate(),
                                        req.getNumberOfDays(),
                                        req.getStatus()
                        });
                }
        ...
        private void initComponents() {
                                                                ...
                                                                .addGroup(jPanel1Layout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(jPanel1Layout
                                                                                                ...
                                                                                                .addGroup(jPanel1Layout
                                                                                                                ...
                                                                                                                .addGroup(jPanel1Layout
                                                                                                                                .createSequentialGroup()
                                                                                                                                .addComponent(vacationLeaveBttn,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(
                                                                                                                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                                                .addComponent(sickLeaveBttn,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                160,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                                ...
                                                                                .addGroup(jPanel1Layout
                                                                                                ...
                                                                                                .addGroup(jPanel1Layout
                                                                                                                ...
                                                                                                                .addGroup(jPanel1Layout
                                                                                                                                .createSequentialGroup()
                                                                                                                                .addComponent(cancelLeaveButton,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                81,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addPreferredGap(
                ...
                jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
                                new java.awt.Component[] { sickLeaveBttn, vacationLeaveBttn });
