...
public class DisplayEmployeeInfo extends javax.swing.JDialog {
        ...
        private void loadEmployee(String employeeNumber) {
                Employee emp = EmployeeService.getEmployeeById(employeeNumber);

                if (emp == null)
                        return;

                // Store current employee to preserve type when updating
        ...
        private void setEditMode(boolean isEditing) {
                for (JTextComponent field : empInfoFieldList) {
                        ...
                        field.setCursor(
                                        new java.awt.Cursor(isEditing ? java.awt.Cursor.TEXT_CURSOR
        ...
        private void initComponents() {
                ...
                empStatus.setModel(
                                new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Select Status", "Probationary", "Regular" }));
                ...
                empPosition.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Position",
                                "Chief Executive Officer", "Chief Finance Officer", "IT Operations and Systems",
                                "HR Manager",
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 993,
                                                                Short.MAX_VALUE));
                layout.setVerticalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 517,
                                                                Short.MAX_VALUE));
        ...
        private void deleteEmpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_deleteEmpButtonActionPerformed
                ...
                if (employeeNumber.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Employee Number is missing.", "Error",
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                        try {
                                ...
                                hrService.deleteEmployee(employeeNumber);
        ...
        private void saveEmpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveEmpButtonActionPerformed
                try {
                        ...
                        // Create updated employee with same type
                        Employee updated = hrService.createEmployeeOfSameType(
                                        currentEmployee,
                                        empNum.getText().trim(),
                        ...
                        hrService.updateEmployee(updated);
        ...
        private void cancelEmpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cancelEmpButtonActionPerformed
                setEditMode(false);
                loadEmployee(empNum.getText().trim());
