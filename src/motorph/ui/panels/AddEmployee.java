        ...
        private void initComponents() {
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 997,
                                                                Short.MAX_VALUE));
        ...
        private void addEmpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addEmpButtonActionPerformed
                try {
                        ...
                        try {
                                ...
                                JOptionPane.showMessageDialog(this, "Invalid birthday format. Please use MM/dd/yyyy.",
                                                "Input Error",
                        ...
                        // Create new employee as EmployeeUser (default role)
                        Employee newEmployee = new EmployeeUser(
                                        newEmployeeNumber,
                                        lastName.getText(),
                                        firstName.getText(),
                        ...
                        String newEmployeeId = hrService.addEmployee(newEmployee);

                        JOptionPane.showMessageDialog(this, "Employee added with ID: " + newEmployeeId);
